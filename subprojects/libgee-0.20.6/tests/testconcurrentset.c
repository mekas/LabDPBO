/* testconcurrentset.c generated by valac 0.56.3, the Vala compiler
...
enum  {
	CONCURRENT_SET_TESTS_0_PROPERTY,
	CONCURRENT_SET_TESTS_NUM_PROPERTIES
};
static GParamSpec* concurrent_set_tests_properties[CONCURRENT_SET_TESTS_NUM_PROPERTIES];
...
static GType concurrent_set_tests_get_type_once (void);

ConcurrentSetTests*
concurrent_set_tests_construct (GType object_type)
{
...
static void
concurrent_set_tests_class_init (ConcurrentSetTestsClass * klass,
                                 gpointer klass_data)
{
	concurrent_set_tests_parent_class = g_type_class_peek_parent (klass);
	((GeeTestCaseClass *) klass)->set_up = (void (*) (GeeTestCase*)) concurrent_set_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = (void (*) (GeeTestCase*)) concurrent_set_tests_real_tear_down;
}

static void
concurrent_set_tests_instance_init (ConcurrentSetTests * self,
                                    gpointer klass)
{
}

static GType
concurrent_set_tests_get_type_once (void)
{
	...
	return concurrent_set_tests_type_id;
}

GType
concurrent_set_tests_get_type (void)
{
	static volatile gsize concurrent_set_tests_type_id__once = 0;
	if (g_once_init_enter (&concurrent_set_tests_type_id__once)) {
		GType concurrent_set_tests_type_id;
		concurrent_set_tests_type_id = concurrent_set_tests_get_type_once ();
		g_once_init_leave (&concurrent_set_tests_type_id__once, concurrent_set_tests_type_id);
	}
	return concurrent_set_tests_type_id__once;
}
