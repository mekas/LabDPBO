/* testconcurrentlist.c generated by valac 0.56.3, the Vala compiler
...
enum  {
	CONCURRENT_LIST_TESTS_0_PROPERTY,
	CONCURRENT_LIST_TESTS_NUM_PROPERTIES
};
static GParamSpec* concurrent_list_tests_properties[CONCURRENT_LIST_TESTS_NUM_PROPERTIES];
...
static GType concurrent_list_tests_get_type_once (void);

ConcurrentListTests*
concurrent_list_tests_construct (GType object_type)
{
...
static void
concurrent_list_tests_class_init (ConcurrentListTestsClass * klass,
                                  gpointer klass_data)
{
	concurrent_list_tests_parent_class = g_type_class_peek_parent (klass);
	((GeeTestCaseClass *) klass)->set_up = (void (*) (GeeTestCase*)) concurrent_list_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = (void (*) (GeeTestCase*)) concurrent_list_tests_real_tear_down;
}

static void
concurrent_list_tests_instance_init (ConcurrentListTests * self,
                                     gpointer klass)
{
}

static GType
concurrent_list_tests_get_type_once (void)
{
	...
	return concurrent_list_tests_type_id;
}

GType
concurrent_list_tests_get_type (void)
{
	static volatile gsize concurrent_list_tests_type_id__once = 0;
	if (g_once_init_enter (&concurrent_list_tests_type_id__once)) {
		GType concurrent_list_tests_type_id;
		concurrent_list_tests_type_id = concurrent_list_tests_get_type_once ();
		g_once_init_leave (&concurrent_list_tests_type_id__once, concurrent_list_tests_type_id);
	}
	return concurrent_list_tests_type_id__once;
}
