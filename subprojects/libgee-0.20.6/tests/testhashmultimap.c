/* testhashmultimap.c generated by valac 0.56.3, the Vala compiler
...
enum  {
	HASH_MULTI_MAP_TESTS_0_PROPERTY,
	HASH_MULTI_MAP_TESTS_NUM_PROPERTIES
};
static GParamSpec* hash_multi_map_tests_properties[HASH_MULTI_MAP_TESTS_NUM_PROPERTIES];
...
static GType hash_multi_map_tests_get_type_once (void);

static void
_hash_multi_map_tests_test_selected_functions_gee_test_case_test_method (gpointer self)
{
	hash_multi_map_tests_test_selected_functions ((HashMultiMapTests*) self);
}

HashMultiMapTests*
hash_multi_map_tests_construct (GType object_type)
{
...
HashMultiMapTests*
hash_multi_map_tests_new (void)
{
	return hash_multi_map_tests_construct (TYPE_HASH_MULTI_MAP_TESTS);
}

static void
hash_multi_map_tests_real_set_up (GeeTestCase* base)
{
...
static void
hash_multi_map_tests_real_tear_down (GeeTestCase* base)
{
	HashMultiMapTests * self;
	self = (HashMultiMapTests*) base;
	_g_object_unref0 (((MultiMapTests*) self)->test_multi_map);
...
hash_multi_map_tests_test_selected_functions (HashMultiMapTests* self)
{
	GeeHashMultiMap* test_hash_multi_map = NULL;
	GeeMultiMap* _tmp0_;
...
static void
hash_multi_map_tests_class_init (HashMultiMapTestsClass * klass,
                                 gpointer klass_data)
{
	hash_multi_map_tests_parent_class = g_type_class_peek_parent (klass);
	((GeeTestCaseClass *) klass)->set_up = (void (*) (GeeTestCase*)) hash_multi_map_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = (void (*) (GeeTestCase*)) hash_multi_map_tests_real_tear_down;
}

static void
hash_multi_map_tests_instance_init (HashMultiMapTests * self,
                                    gpointer klass)
{
}

static GType
hash_multi_map_tests_get_type_once (void)
{
	...
	return hash_multi_map_tests_type_id;
}

GType
hash_multi_map_tests_get_type (void)
{
	static volatile gsize hash_multi_map_tests_type_id__once = 0;
	if (g_once_init_enter (&hash_multi_map_tests_type_id__once)) {
		GType hash_multi_map_tests_type_id;
		hash_multi_map_tests_type_id = hash_multi_map_tests_get_type_once ();
		g_once_init_leave (&hash_multi_map_tests_type_id__once, hash_multi_map_tests_type_id);
	}
	return hash_multi_map_tests_type_id__once;
}
