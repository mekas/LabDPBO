/* testmultiset.c generated by valac 0.56.3, the Vala compiler
...
enum  {
	MULTI_SET_TESTS_0_PROPERTY,
	MULTI_SET_TESTS_NUM_PROPERTIES
};
static GParamSpec* multi_set_tests_properties[MULTI_SET_TESTS_NUM_PROPERTIES];
...
VALA_EXTERN MultiSetTests* multi_set_tests_construct (GType object_type,
                                          const gchar* name);
...
static GType multi_set_tests_get_type_once (void);

static void
_multi_set_tests_test_duplicates_are_retained_gee_test_case_test_method (gpointer self)
{
	multi_set_tests_test_duplicates_are_retained ((MultiSetTests*) self);
}

MultiSetTests*
multi_set_tests_construct (GType object_type,
                           const gchar* name)
{
	MultiSetTests * self = NULL;
	g_return_val_if_fail (name != NULL, NULL);
	self = (MultiSetTests*) collection_tests_construct (object_type, name);
...
multi_set_tests_test_duplicates_are_retained (MultiSetTests* self)
{
	...
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 0, "test_multi_set.count (\"one\") == 0");
	_vala_assert (gee_collection_add ((GeeCollection*) test_multi_set, "one"), "test_multi_set.add (\"one\")");
	_vala_assert (gee_collection_contains ((GeeCollection*) test_multi_set, "one"), "test_multi_set.contains (\"one\")");
	_tmp2_ = gee_collection_get_size ((GeeCollection*) test_multi_set);
	_tmp3_ = _tmp2_;
	_vala_assert (_tmp3_ == 1, "test_multi_set.size == 1");
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 1, "test_multi_set.count (\"one\") == 1");
	_vala_assert (gee_collection_add ((GeeCollection*) test_multi_set, "one"), "test_multi_set.add (\"one\")");
	_vala_assert (gee_collection_contains ((GeeCollection*) test_multi_set, "one"), "test_multi_set.contains (\"one\")");
	_tmp4_ = gee_collection_get_size ((GeeCollection*) test_multi_set);
	_tmp5_ = _tmp4_;
	_vala_assert (_tmp5_ == 2, "test_multi_set.size == 2");
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 2, "test_multi_set.count (\"one\") == 2");
	_vala_assert (gee_collection_add ((GeeCollection*) test_multi_set, "one"), "test_multi_set.add (\"one\")");
	_vala_assert (gee_collection_contains ((GeeCollection*) test_multi_set, "one"), "test_multi_set.contains (\"one\")");
	_tmp6_ = gee_collection_get_size ((GeeCollection*) test_multi_set);
	_tmp7_ = _tmp6_;
	_vala_assert (_tmp7_ == 3, "test_multi_set.size == 3");
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 3, "test_multi_set.count (\"one\") == 3");
	_vala_assert (gee_collection_remove ((GeeCollection*) test_multi_set, "one"), "test_multi_set.remove (\"one\")");
	_vala_assert (gee_collection_contains ((GeeCollection*) test_multi_set, "one"), "test_multi_set.contains (\"one\")");
	_tmp8_ = gee_collection_get_size ((GeeCollection*) test_multi_set);
	_tmp9_ = _tmp8_;
	_vala_assert (_tmp9_ == 2, "test_multi_set.size == 2");
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 2, "test_multi_set.count (\"one\") == 2");
	_vala_assert (gee_collection_remove ((GeeCollection*) test_multi_set, "one"), "test_multi_set.remove (\"one\")");
	_vala_assert (gee_collection_contains ((GeeCollection*) test_multi_set, "one"), "test_multi_set.contains (\"one\")");
	_tmp10_ = gee_collection_get_size ((GeeCollection*) test_multi_set);
	_tmp11_ = _tmp10_;
	_vala_assert (_tmp11_ == 1, "test_multi_set.size == 1");
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 1, "test_multi_set.count (\"one\") == 1");
	_vala_assert (gee_collection_remove ((GeeCollection*) test_multi_set, "one"), "test_multi_set.remove (\"one\")");
	_vala_assert (!gee_collection_contains ((GeeCollection*) test_multi_set, "one"), "!test_multi_set.contains (\"one\")");
	_tmp12_ = gee_collection_get_size ((GeeCollection*) test_multi_set);
	_tmp13_ = _tmp12_;
	_vala_assert (_tmp13_ == 0, "test_multi_set.size == 0");
	_vala_assert (gee_multi_set_count (test_multi_set, "one") == 0, "test_multi_set.count (\"one\") == 0");
	_g_object_unref0 (test_multi_set);
}

static void
multi_set_tests_class_init (MultiSetTestsClass * klass,
                            gpointer klass_data)
{
...
static void
multi_set_tests_instance_init (MultiSetTests * self,
                               gpointer klass)
{
}

static GType
multi_set_tests_get_type_once (void)
{
	...
	return multi_set_tests_type_id;
}

GType
multi_set_tests_get_type (void)
{
	static volatile gsize multi_set_tests_type_id__once = 0;
	if (g_once_init_enter (&multi_set_tests_type_id__once)) {
		GType multi_set_tests_type_id;
		multi_set_tests_type_id = multi_set_tests_get_type_once ();
		g_once_init_leave (&multi_set_tests_type_id__once, multi_set_tests_type_id);
	}
	return multi_set_tests_type_id__once;
}
