/* testtreemultiset.c generated by valac 0.56.3, the Vala compiler
...
enum  {
	TREE_MULTI_SET_TESTS_0_PROPERTY,
	TREE_MULTI_SET_TESTS_NUM_PROPERTIES
};
static GParamSpec* tree_multi_set_tests_properties[TREE_MULTI_SET_TESTS_NUM_PROPERTIES];
...
static GType tree_multi_set_tests_get_type_once (void);

TreeMultiSetTests*
tree_multi_set_tests_construct (GType object_type)
{
...
static void
tree_multi_set_tests_class_init (TreeMultiSetTestsClass * klass,
                                 gpointer klass_data)
{
	tree_multi_set_tests_parent_class = g_type_class_peek_parent (klass);
	((GeeTestCaseClass *) klass)->set_up = (void (*) (GeeTestCase*)) tree_multi_set_tests_real_set_up;
	((GeeTestCaseClass *) klass)->tear_down = (void (*) (GeeTestCase*)) tree_multi_set_tests_real_tear_down;
}

static void
tree_multi_set_tests_instance_init (TreeMultiSetTests * self,
                                    gpointer klass)
{
}

static GType
tree_multi_set_tests_get_type_once (void)
{
	...
	return tree_multi_set_tests_type_id;
}

GType
tree_multi_set_tests_get_type (void)
{
	static volatile gsize tree_multi_set_tests_type_id__once = 0;
	if (g_once_init_enter (&tree_multi_set_tests_type_id__once)) {
		GType tree_multi_set_tests_type_id;
		tree_multi_set_tests_type_id = tree_multi_set_tests_get_type_once ();
		g_once_init_leave (&tree_multi_set_tests_type_id__once, tree_multi_set_tests_type_id);
	}
	return tree_multi_set_tests_type_id__once;
}
