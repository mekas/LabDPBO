/* testhashmap.c generated by valac 0.56.3, the Vala compiler
...
enum  {
	...
	HASH_MAP_TESTS_NUM_PROPERTIES
};
static GParamSpec* hash_map_tests_properties[HASH_MAP_TESTS_NUM_PROPERTIES];
...
static GType hash_map_tests_get_type_once (void);

HashMapTests*
hash_map_tests_construct (GType object_type)
{
...
HashMapTests*
hash_map_tests_new (void)
{
	return hash_map_tests_construct (TYPE_HASH_MAP_TESTS);
}

static void
hash_map_tests_real_set_up (GeeTestCase* base)
{
	HashMapTests * self;
	GeeHashMap* _tmp0_;
...
static void
hash_map_tests_real_tear_down (GeeTestCase* base)
{
	HashMapTests * self;
	self = (HashMapTests*) base;
	_g_object_unref0 (((MapTests*) self)->test_map);
...
static void
hash_map_tests_class_init (HashMapTestsClass * klass,
                           gpointer klass_data)
{
...
static void
hash_map_tests_instance_init (HashMapTests * self,
                              gpointer klass)
{
}

static GType
hash_map_tests_get_type_once (void)
{
	...
	return hash_map_tests_type_id;
}

GType
hash_map_tests_get_type (void)
{
	static volatile gsize hash_map_tests_type_id__once = 0;
	if (g_once_init_enter (&hash_map_tests_type_id__once)) {
		GType hash_map_tests_type_id;
		hash_map_tests_type_id = hash_map_tests_get_type_once ();
		g_once_init_leave (&hash_map_tests_type_id__once, hash_map_tests_type_id);
	}
	return hash_map_tests_type_id__once;
}
